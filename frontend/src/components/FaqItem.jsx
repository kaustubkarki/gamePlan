...
FaqItem.propTypes = {
  item: PropTypes.shape({
    id: PropTypes.oneOfType([PropTypes.string, PropTypes.number]).isRequired, // id is required and can be a string or number
    question: PropTypes.string.isRequired, // question is required and should be a string
    answer: PropTypes.string.isRequired, // answer is required and should be a string
  }).isRequired,
